#!/usr/bin/env python3
'''
Disable the screensaver on i3.

This is from https://github.com/acrisci/i3ipc-python/blob/master/examples/disable-standby-fs.py
Please take a look there for any updates.
'''
